...
BLOG_AUTHOR = "The Nikola Team"  # (translatable)
BLOG_TITLE = "Plugins for Nikola"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "https://plugins.getnikola.com/"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "https://plugins.getnikola.com/"
BLOG_EMAIL = "info@getnikola.com"
BLOG_DESCRIPTION = "The plugin repository for Nikola, a static site and blog generator."  # (translatable)
...
# (translatable)
CONTENT_FOOTER = '''Contents © 2012–2025 <a href="https://getnikola.com/contact.html">The Nikola contributors</a> and plugin authors&nbsp;&nbsp;|&nbsp;&nbsp;Powered by <a href="https://getnikola.com/">Nikola</a> itself&nbsp;&nbsp;|&nbsp;&nbsp;
...
# before </head>
# (translatable)
EXTRA_HEAD_DATA = """<link rel="stylesheet" href="/assets/css/pkgindex.css">"""
# Google Analytics or whatever else you use. Added to the bottom of <body>
# in the default template (base.tmpl).
# (translatable)
BODY_END = """<script src="/assets/js/pkgindex.js"></script>"""
